...
import '../../App.css'
import { MapPinned,ArrowLeft,ArrowRight} from 'lucide-react';
            ...
            <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center relative z-10">
                ...
                <div className="space-y-3" data-aos="fade-left">
                    ...
                    <div className="space-y-3 text-gray-400 text-lg leading-relaxed max-w-xl">
                        <p>Haloo Cewe Mark Disinii! Kenalin, aku <span className="text-white font-semibold">Dwi Rahmawati</span>...</p>
                        <p>Tiga tahun belajar di <span className="text-white italic">SMKN 3 Pamekasan</span>...</p>
                    </div>
...
function GallerySection() {
    ...
    const galleryItems = [
        ...
        //teman
        { id: 4, category: 'friend', title: 'MAFIAAA', img: "img/gallery/friend/friend1.png"},
        { id: 4, category: 'friend', title: 'Ketuaa PMR', img: "img/gallery/friend/friend17.jpg"},
        { id: 4, category: 'friend', title: 'Nak PMR', img: "img/gallery/friend/friend3.jpg"},
        { id: 4, category: 'friend', title: 'VITAA', img: "img/gallery/friend/friend4.jpeg"},
        { id: 4, category: 'friend', title: 'Gatau G Kenal', img: "img/gallery/friend/friend5.jpg"},
        { id: 4, category: 'friend', title: 'Circle epep', img: "img/gallery/friend/friend6.jpg"},
        { id: 4, category: 'friend', title: 'Sebelum Pisah', img: "img/gallery/friend/friend20.png"},
        { id: 4, category: 'friend', title: 'GENK roblox', img: "img/gallery/friend/friend8.jpg"},
        { id: 4, category: 'friend', title: 'Ketua Mafia x Wakil Mafia', img: "img/gallery/friend/friend9.jpg"},
        { id: 4, category: 'friend', title: 'PUPUTT', img: "img/gallery/friend/friend10.jpeg"},
        { id: 4, category: 'friend', title: 'Ara Araa', img: "img/gallery/friend/friend11.jpg"},
        { id: 4, category: 'friend', title: 'MAFIAAA', img: "img/gallery/friend/friend12.jpg"},
        { id: 4, category: 'friend', title: 'Gatau G Kenal', img: "img/gallery/friend/friend13.jpg"},
        { id: 4, category: 'friend', title: 'Sepiring Nasi Goreng', img: "img/gallery/friend/friend14.jpg"},
        { id: 4, category: 'friend', title: 'Seporsi Seblak', img: "img/gallery/friend/friend15.jpg"},
        { id: 4, category: 'friend', title: 'DESIIII', img: "img/gallery/friend/friend16.jpg"},
        { id: 4, category: 'friend', title: 'Miss', img: "img/gallery/friend/friend21.jpg"},
        { id: 4, category: 'friend', title: 'Ciee yang UKK nya aman', img: "img/gallery/friend/friend24.jpg"},
    ...
    return (
        <section id="galery" className="relative w-full min-h-screen p-5 md:p-10 bg-[#0B1120] text-white overflow-hidden">
            
            <div className='flex flex-col justify-end items-end mb-10'>
                <h3 className="text-[#d1a355] font-mono tracking-widest mb-1 text-sm">CHAPTER 3: MEMORIAL PHOTO</h3>
            ...
            <div className=' flex justify-center items-center gap-2'>
                ...
                <div className="w-full">
                    {filteredItems.length > 0 ? (
                        <>
                            <div className='hidden md:grid md:grid-cols-3 gap-4 auto-rows-[200px]'>
                                {currentItemsDesktop.map((item, index) => (
                                    <div key={index} className='relative group h-full overflow-hidden rounded-xl '>
                                        <img 
                                            src={item.img}  
                                            alt={item.category} 
                            ...
                            <div className='md:hidden flex flex-row gap-4 overflow-x-auto snap-x snap-mandatory pb-6 scrollbar-hide'>
                                {filteredItems.map((item) => (
                                    <div 
                                        key={item.id} 
                                        className={`flex-shrink-0 w-[85%] rounded-xl p-6 h-[200px] flex items-end justify-start snap-center snap-always ${item.style}`}
                                    >
                                        <p className="font-bold text-white/90 backdrop-blur-md bg-black/30 px-3 py-1 rounded-md text-sm">
                                            {item.title}
                                        </p>
                                    </div>
                                ))}
